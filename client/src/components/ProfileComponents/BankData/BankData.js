...
const BankData = ({ userData, onCancel, onSave, isViewer = false, }) => {
    const [updatedData, setUpdatedData] = useState({});
    const [errors, setErrors] = useState({});
    const fields = registerFormData.roles.provider.types.default.formData[3].form;
